 ...
 * @since 4.4
 */
class Action_Subscription_Update_Tax extends Abstract_Action_Subscription_Edit_Tax {
	...
	function load_admin_details() {
		...
		$this->description = __( 'Update a specific tax line item on a subscription. This is useful for bulk editing subscriptions when new tax rates are introduced. Other tax rates will not be modified.', 'automatewoo-subscriptions' );
	}
